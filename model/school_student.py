...
class SchoolStudent(models.Model):
    ...
    first_name = fields.Char(required=True,string ="نام" , required=True)
    last_name = fields.Char(required=True, string = "نام خانوادگی",required=True)
    ...
    student_code = fields.Char(string = "شماره دانش آموزی", required=True)
